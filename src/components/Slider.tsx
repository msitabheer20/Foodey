...
const Slider = () => {
  ...
  return (
    ...
    <div className="flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-8rem)] lg:flex-row">
      {/* TEXT CONTAINER */}
      <div className="flex-1 flex items-center justify-center flex-col gap-4 text-red-500 font-bold bg-fuchsia-50">
        <h1 className="text-4xl text-center uppercase p-4 md:text-5xl xl:text-6xl">
